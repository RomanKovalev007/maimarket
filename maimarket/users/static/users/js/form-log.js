class FormValidation {
    ...
    chekingBlur(target){
        if(target.hasAttribute('required') && target.form.classList.contains('form-registration')){
    ...
    chekingChange(target){
        ...
        if(target.hasAttribute('required') && target.form.classList.contains('form-registration') && checkbox){
            this.FormValidationS(target)
        }
    }
    ...
    chekingSubmit(event){
        ...
        for (const input of fields) {
            if(input.hasAttribute('required') && input.form.classList.contains('form-registration')){
